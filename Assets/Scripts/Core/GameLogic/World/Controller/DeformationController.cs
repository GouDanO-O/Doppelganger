...
namespace GameFrame.World
{
    ...
    public class DeformationController : AbstractController,IDeformation
    {
        ...
        public void TriggerDeformationAppearance(WorldObjData_Config deformationData)
        {
        ...
        public void TriggerDeformationCompletely(WorldObjData_Config deformationData)
        {
